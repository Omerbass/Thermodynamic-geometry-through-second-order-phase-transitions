...
g_{\mu\nu}\;\propto\;\Delta_s^{-1}
\]
Hence, while the metric diverges as $\Delta_s\!\to\!0$, the associated thermodynamic length remains finite—consistent with the scaling-hypothesis argument discussed in Sec.~\ref{subsec:ScalingHypothesisResults}. 
In other words, although curvature quantities diverge at the transition, the thermodynamic length stays bounded when crossing the critical line.
