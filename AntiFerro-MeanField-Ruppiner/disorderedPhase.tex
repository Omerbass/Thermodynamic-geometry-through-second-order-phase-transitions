...
This degeneracy, also observed in the ferromagnetic MF model \cite{janyszekRiemannianGeometryThermodynamics1989}, implies that one eigenvalue of the metric is zero.  
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/disorderedPhaseLines.jpg}
